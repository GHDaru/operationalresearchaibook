...
(function () {
  ...
  var CORES = { capitulo: "#e0a24a", conceito: "#6fd08a" };
  var NOMES = { capitulo: "Capítulos", conceito: "Conceitos" };
  var RAIO = { capitulo: 11, conceito: 8 };
  ...
  function iniciar(g) {
    ...
    var visiveis = { capitulo: true, conceito: true };
