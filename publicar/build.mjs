...
const COMPANION_CAPS = [
  ...
  { chave: "fluxo_custo", rotulo: "Fluxo de custo mínimo", libera: 20 },
  { chave: "designacao", rotulo: "Transporte e designação", libera: 21 },
  { chave: "projetos", rotulo: "PERT, CPM e prazo", libera: 22 },
